...
uint256 hashGenesisBlock("0x0000006f98a155f58f05b0e713cf6125de3282741167319e20f3c7cc48a77b79");
static const unsigned int timeGenesisBlock = 1395761016;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    int64 LimitUp2 = nTargetTimespan * 100 / 105;

    if (nActualTimespan < nTargetTimespan/4 && pHeight >= 48001)
       {
        nActualTimespan = LimitUp2;
       }
    if (nActualTimespan < LimitUp && pHeight <= 48000)
       {
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "Google turns down military money for robot competition Unix timestamp 1395761016";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x317461793b288770cc61963e14eda8104802803d47d681875f91e91beb73795d"));
